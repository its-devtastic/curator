...
const Auth: React.FC = () => (
  <SecretsProvider>
    <div className="flex flex-col h-screen">
      <AppHeader />
      <MainMenu />
      <div className="flex-1 flex flex-col items-center overflow-y-auto bg-white dark:bg-gray-900">
      ...
      <footer className="w-full border-t border-solid border-0 border-gray-200 dark:border-gray-700 dark:bg-gray-800">
        <div className="py-1 px-4 md:px-12 max-w-screen-xl mx-auto flex items-center justify-center md:justify-end gap-6">
          ...
          />
          <div className="text-xs font-semibold text-gray-400 dark:text-gray-200 select-none">{`version ${pkg.version}`}</div>
